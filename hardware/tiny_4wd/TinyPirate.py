...
# Imported from https://raw.githubusercontent.com/Coretec-Robotics/Tiny_4wd/master/TinyPirate.py
...
try:
    ...
    # This is to allow me to run tests of helper functions on Windows
    pass
